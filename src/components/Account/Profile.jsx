      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <form className="space-y-6" onSubmit={handleFormSubmit}>
          ...
          <div>
            ...
            >
              Pick 6 New Random Avatars
            </button>
            <button
              type="submit"
              disabled={loading}
              className="w-full mt-4 py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            >
              Update Profile
            </button>
          </div>
